...
import GestionResutltatsPourcentage.ParBurVote;
import GestionResutltatsPourcentage.Globalement;
import GestionResutltatsPourcentage.PartiVainqueur;
import GestionResutltatsPourcentage.PartiAyantAucunVote;

public class PourcentageVoteparParti extends JFrame{
	...
	public static PourcentageVoteparParti frame4_1 = new PourcentageVoteparParti();
	 ...
	 * Create the frame.
	 */
	public PourcentageVoteparParti() {
	...
	setSize(800,680);//dimensions de l'interface
	 ...
	 setTitle("AFFICHAGE DU POURCENTAGE DE VOTES PAR PARTI");//titre de la fenêtre
	...
	titre1 = new JLabel("L'Affichage du pourcentage");
	...
	titre1.setBounds(125,50,650,60);//changement de dimension
	contentPane.add(titre1);
	
	titre2 = new JLabel("de votes obtenu par Parti");
	...
	titre2.setBounds(140,100,650,60);//changement de dimension
	...
	valider.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			{if (!Character.isDigit(x.charAt(0)))
				...
				{switch (xi)
					{case 1: 
						ParBurVote menu4_2_1=new ParBurVote();
						close();//fermeture du ParBurVote(sous menu4_2)
						menu4_2_1.setVisible(true);// la fenêtre menu4_2_1 est par défaut invisible alors il faut la rendre visible à l'aide de cette méthode 												
						break;
					
					case 2: 
						Globalement menu4_2_2=new Globalement();
						close();//fermeture du Globalement(sous menu4_2)
						menu4_2_2.setVisible(true);// la fenêtre menu4_2_2 est par défaut invisible alors il faut la rendre visible à l'aide de cette méthode 
						break;
						
					case 3: 
						PartiVainqueur menu4_2_3=new PartiVainqueur();
						close();//fermeture du PartiVainqueur(sous menu4_2)
						menu4_2_3.setVisible(true);// la fenêtre menu4_2_3 est par défaut invisible alors il faut la rendre visible à l'aide de cette méthode 
						break;
						
					case 4: 
						PartiAyantAucunVote menu4_2_4=new PartiAyantAucunVote();
						close();//fermeture du PartiAyantAucunVote(sous menu4_2)
						menu4_2_4.setVisible(true);// la fenêtre menu4_2_4 est par défaut invisible alors il faut la rendre visible à l'aide de cette méthode 
						break;
