...
public class ParBurVote extends JFrame{
	...
	public ParBurVote() {
		...
		setTitle("AFFICHAGE DU NOMBRE DE VOTES PAR PARTI PAR BUREAU DE VOTE");//titre de la fenêtre
		...
		nbrvote.setBounds(305, 170, 430, 340);
		...
		retourlbl.setBounds(37, 416, 100, 100);
